...
Shader::Shader(const char* vertexName, const char* fragmentName)
{
    ...
    try 
    {
        vShaderFile.open(loader.loadShader(vertexName, windows));
        fShaderFile.open(loader.loadShader(fragmentName, windows));
...
Shader::Shader(const char* vertexName, const char* geometryName, const char* fragmentName)
{
    ...
    try 
    {
        vShaderFile.open(loader.loadShader(vertexName, windows));
        fShaderFile.open(loader.loadShader(fragmentName, windows));
        gShaderFile.open(loader.loadShader(geometryName, windows));
